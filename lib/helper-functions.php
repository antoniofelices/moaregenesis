 ...
 * Moare Genesis.
 *
 * This file adds the required helper functions used in the Moare Genesis Starter Theme.
 *
 ...
 */
function mg_color_contrast( $color ) {
 ...
 */
function mg_color_brightness( $color, $change ) {
