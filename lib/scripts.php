...
function mg_enqueue_scripts_styles() {
	...
	wp_enqueue_style(
		'mainstyles', get_stylesheet_directory_uri() . "/assets/stylesheets/main.css", [], genesis_get_theme_version(), null
	);
	wp_enqueue_script(
		'mainscripts', get_stylesheet_directory_uri() . "/assets/js/main.js", array('jquery'), genesis_get_theme_version(), true
	);
